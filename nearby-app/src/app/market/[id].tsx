...
export default function Market() {
    ...
    async function handleOpenCamera() {
        try {
            ...
            if (!granted) {
                return Alert.alert("Câmera", "É preciso habilitar o uso da câmera para essa função")
            }
            ...
            console.log(error);
            Alert.alert("Câmera", "Não foi possível acessar a câmera, verifique as permissões")
        }
    }
    ...
    function handleUseCoupon(id: string) {
        ...
        Alert.alert("Cupom", "Não é possível reutilizar um cupom que já foi resgatado. Deseja realmente resgatar o cupom?",
            [
